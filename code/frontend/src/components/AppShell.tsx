...
export default function AppShell() {
  ...
  return (
    <div className="min-h-screen bg-bg-page">
      <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:z-50 focus:bg-ims-yellow focus:p-4 focus:text-black">Skip to content</a>
      <header className="border-b border-[#2E2E2E]">
        <nav aria-label="Main navigation" className="flex h-12 items-center bg-bg-app px-3.5">
          <Link to="/" className="mr-1.5 flex shrink-0 items-center gap-2">
            ...
            <span className="text-[13px] font-extrabold tracking-[0.06em]"><span className="text-white">THE</span><span className="text-ims-yellow">IMS</span></span>
          </Link>

          <div className="ml-3 flex h-12 items-end">
            <DropdownMenu.Root>
              <DropdownMenu.Trigger className="flex h-12 items-center border-b-2 border-ims-yellow px-3.5 text-xs font-medium text-ims-yellow">
          ...
          {user && (
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="text-xs text-white hover:text-ims-yellow"
              >
                Log Out
              </button>
              <div className="ml-2 flex h-7 w-7 items-center justify-center rounded-full bg-ims-yellow text-[10px] font-bold text-text-primary">
                {initials}
              </div>
            </div>
          )}
