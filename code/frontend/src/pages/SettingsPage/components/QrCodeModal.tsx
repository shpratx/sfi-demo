    ...
    <Dialog.Root open={open} onOpenChange={(v) => !v && onClose()}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          className="fixed left-1/2 top-1/2 w-[360px] -translate-x-1/2 -translate-y-1/2 rounded-[3px] border-t-[3px] border-hive-yellow bg-bg-surface p-6 text-center shadow-[0_4px_24px_rgba(0,0,0,0.3)] focus:outline-none"
        >
          <Dialog.Title id="qr-title" className="mb-4 text-[14px] font-bold leading-snug text-text-primary">
            QR Code for {orgName}
            <br />
            Driver Check In Access
          </Dialog.Title>

          <div className="mx-auto mb-4 flex h-[190px] w-[190px] items-center justify-center rounded-[3px] border border-border-light bg-[#F5F5F5]">
            {blobUrl && (
              <img
                src={blobUrl}
          ...
          <div className="flex justify-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-[3px] bg-hive-yellow px-3.5 py-2 text-xs font-semibold text-text-primary hover:bg-hive-yellow-dark"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-[3px] bg-[#1A1A1A] px-3.5 py-2 text-xs font-semibold text-white hover:bg-[#2a2a2a]"
            >
            ...
            <Dialog.Close asChild>
              <button
                type="button"
                className="inline-flex items-center gap-1.5 rounded-[3px] border border-border-input bg-transparent px-3.5 py-2 text-xs font-semibold text-text-secondary hover:border-[#999] hover:text-text-primary"
              >
