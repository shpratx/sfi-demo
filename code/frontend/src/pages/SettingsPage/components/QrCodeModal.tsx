    ...
    <Dialog.Root open={open} onOpenChange={(v) => !v && onClose()}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          className="fixed left-1/2 top-1/2 w-[360px] -translate-x-1/2 -translate-y-1/2 rounded-[3px] border-t-[3px] border-ims-yellow bg-bg-surface p-6 text-center shadow-[0_4px_24px_rgba(0,0,0,0.3)] focus:outline-none"
        >
          ...
          <div className="flex justify-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-[3px] bg-ims-yellow px-3.5 py-2 text-xs font-semibold text-text-primary hover:bg-ims-yellow-dark"
            >
